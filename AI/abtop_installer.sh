...
# [abtop - Like btop, but for your AI coding agents](https://github.com/graykode/abtop)
INSTALLER_APP_NAME="abtop"
INSTALLER_GITHUB_REPO="graykode/abtop"

INSTALLER_ARCHIVE_EXT="tar.xz"
INSTALLER_INSTALL_NAME="abtop"
