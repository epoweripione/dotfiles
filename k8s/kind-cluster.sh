...
[[ ! -x "$(command -v kind)" && "$(command -v mise)" ]] && mise use --global helm@latest
...
[[ ! -x "$(command -v kubectl)" && "$(command -v mise)" ]] && mise use --global kubectl@latest
...
[[ ! -x "$(command -v helm)" && "$(command -v mise)" ]] && mise use --global helm@latest
...
# [[ ! -x "$(command -v istioctl)" && "$(command -v mise)" ]] && mise use --global istioctl@latest
