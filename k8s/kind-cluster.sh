...
[[ ! -x "$(command -v kind)" && "$(command -v mise)" ]] && mise global helm@latest
...
[[ ! -x "$(command -v helm)" && "$(command -v mise)" ]] && mise global helm@latest
...
# [[ ! -x "$(command -v istioctl)" && "$(command -v mise)" ]] && mise global istioctl@latest
