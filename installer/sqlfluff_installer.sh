...
# [SQLFluff - The SQL Linter for Humans](https://github.com/sqlfluff/sqlfluff)
INSTALLER_APP_NAME="sqlfluff"
INSTALLER_INSTALL_NAME="sqlfluff"

PIP_PACKAGE_NAME="sqlfluff"
