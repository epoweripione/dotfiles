...
# restic - ast, secure, efficient backup program
# https://github.com/restic/restic
APP_INSTALL_NAME="restic"
GITHUB_REPO_NAME="restic/restic"
...
if [[ "${IS_INSTALL}" == "yes" ]]; then
    ...
    REMOTE_FILENAME="${APP_INSTALL_NAME}_${REMOTE_VERSION}_${OS_INFO_TYPE}_${OS_INFO_ARCH}.${ARCHIVE_EXT}"
