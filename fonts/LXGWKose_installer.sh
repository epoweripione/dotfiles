...
# [小赖字体/小賴字體/シャオライ/Xiaolai Font](https://github.com/lxgw/kose-font)
INSTALLER_APP_NAME="小赖字体/小賴字體"
INSTALLER_GITHUB_REPO="lxgw/kose-font"
INSTALLER_INSTALL_NAME="LXGWKose"

INSTALLER_MATCH_PATTERN="Xiaolai*"
