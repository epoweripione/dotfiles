...
# [LXGW Marker Gothic/霞鹜漫黑](https://github.com/lxgw/LxgwMarkerGothic)
INSTALLER_APP_NAME="LXGW Marker Gothic/霞鹜漫黑"
INSTALLER_GITHUB_REPO="lxgw/LxgwMarkerGothic"
INSTALLER_INSTALL_NAME="LxgwMarkerGothic"

INSTALLER_MATCH_PATTERN="LXGWMarkerGothic*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWMarkerGothic-Regular.ttf"
    )
