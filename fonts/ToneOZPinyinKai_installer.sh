...
# [澳声通拼音鼎楷-简/拼音庫楷-繁](https://github.com/jeffreyxuan/toneoz-font-pinyin-kai)
INSTALLER_APP_NAME="澳声通拼音鼎楷-简/拼音庫楷-繁"
INSTALLER_GITHUB_REPO="jeffreyxuan/toneoz-font-pinyin-kai"
INSTALLER_INSTALL_NAME="ToneOZPinyinKai"

INSTALLER_MATCH_PATTERN="ToneOZ*-Kai*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/ToneOZ-Pinyin-Kai-Simplified.ttf"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/ToneOZ-PinyinW-Kai-Simplified.ttf"
    )
