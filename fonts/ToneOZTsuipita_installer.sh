...
# [曉聲通秋茄](https://github.com/jeffreyxuan/toneoz-font-tsuipita)
INSTALLER_APP_NAME="曉聲通秋茄"
INSTALLER_GITHUB_REPO="jeffreyxuan/toneoz-font-tsuipita"
INSTALLER_INSTALL_NAME="ToneOZTsuipita"

INSTALLER_MATCH_PATTERN="ToneOZ*Tsuipita*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/ToneOZ-Pinyin-Tsuipita-TC.zip"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/ToneOZ-Tsuipita-TC.zip"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/ToneOZ-YinPZ-Tsuipita-TC.zip"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/ToneOZ-Zhuyin-Tsuipita-TC.zip"
    )
