...
INSTALLER_APP_NAME="LXGW ZhiSong/霞鶩緻宋/LXGW 緻明朝"
INSTALLER_GITHUB_REPO="lxgw/LxgwZhiSong"
INSTALLER_INSTALL_NAME="LxgwZhiSong"

INSTALLER_MATCH_PATTERN="LXGWZhiSong*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWZhiSongCL.ttf"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWZhiSongMN.ttf"
    )
