...
# [萌神拼音](https://github.com/MaruTama/Mengshen-pinyin-font)
INSTALLER_APP_NAME="萌神拼音"
INSTALLER_GITHUB_REPO="MaruTama/Mengshen-pinyin-font"
INSTALLER_INSTALL_NAME="MengshenPinyin"

INSTALLER_MATCH_PATTERN="Mengshen*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/${INSTALLER_VER_REMOTE}/Mengshen.zip"
    )
