...
# [【辰宇落雁體】── 複寫呢喃，為你成篇](https://github.com/Chenyu-otf/chenyuluoyan_thin)
INSTALLER_APP_NAME="辰宇落雁體"
INSTALLER_GITHUB_REPO="Chenyu-otf/chenyuluoyan_thin"
INSTALLER_INSTALL_NAME="chenyuluoyan"

INSTALLER_MATCH_PATTERN="ChenYuluoyan*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/ChenYuluoyan-Thin.ttf"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}-monospaced/ChenYuluoyan-Thin-Monospaced.ttf"
    )
