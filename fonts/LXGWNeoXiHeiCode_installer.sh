...
INSTALLER_APP_NAME="新晰黑 Code/NeoXiHei Code"
INSTALLER_GITHUB_REPO="lxgw/NeoXiHei-Code"
INSTALLER_INSTALL_NAME="LXGWNeoXiHeiCode"

INSTALLER_MATCH_PATTERN="NeoXiHeiCode*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_CHECK_URL="https://api.github.com/repos/lxgw/LxgwNeoXiHei/releases/latest"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/raw/main/NeoXiHeiCode-Regular.ttf"
    )
