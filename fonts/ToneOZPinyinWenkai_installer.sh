...
INSTALLER_APP_NAME="澳声通拼音文楷"
INSTALLER_GITHUB_REPO="jeffreyxuan/toneoz-font-pinyin-wenkai"
INSTALLER_INSTALL_NAME="ToneOZPinyinWenkai"

INSTALLER_MATCH_PATTERN="ToneOZ*-WenKai*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/ToneOZ-Pinyin-WenKai.zip"
    )
