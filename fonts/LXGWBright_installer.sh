...
INSTALLER_APP_NAME="LXGW Bright"
INSTALLER_GITHUB_REPO="lxgw/LxgwBright"
INSTALLER_INSTALL_NAME="LXGWBright"

INSTALLER_MATCH_PATTERN="LXGWBright*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWBright.7z"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWBrightGB.7z"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWBrightTC.7z"
    )
