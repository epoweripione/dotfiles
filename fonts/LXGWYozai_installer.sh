...
INSTALLER_APP_NAME="悠哉字体/Yozai Font"
INSTALLER_GITHUB_REPO="lxgw/yozai-font"
INSTALLER_INSTALL_NAME="LXGWYozai"

INSTALLER_MATCH_PATTERN="Yozai*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/Yozai-Light.ttf"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/Yozai-Medium.ttf"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/Yozai-Regular.ttf"
    )
