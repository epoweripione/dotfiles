...
# [LXGW ZhenKai/霞鹜臻楷](https://github.com/lxgw/LxgwZhenKai)
INSTALLER_APP_NAME="LXGW ZhenKai/霞鹜臻楷"
INSTALLER_GITHUB_REPO="lxgw/LxgwZhenKai"
INSTALLER_INSTALL_NAME="LxgwZhenKai"

INSTALLER_MATCH_PATTERN="LXGWZhenKai*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWZhenKai-Regular.ttf"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWZhenKaiGB-Regular.ttf"
    )
