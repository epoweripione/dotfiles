...
# [澳声通注音多音字型庫楷-繁/鼎楷-简](https://github.com/jeffreyxuan/toneoz-font-zhuyin)
INSTALLER_APP_NAME="澳声通注音多音字型庫楷-繁/鼎楷-简"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/ToneOZ-RadicalZ-KaiTraditional.ttf"
    )
