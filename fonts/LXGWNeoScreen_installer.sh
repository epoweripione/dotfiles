...
INSTALLER_APP_NAME="霞鹜新晰黑＆霞鹜新致宋 屏幕阅读版"
INSTALLER_GITHUB_REPO="lxgw/LxgwNeoXiZhi-Screen"
INSTALLER_INSTALL_NAME="LXGWNeoScreen"

INSTALLER_MATCH_PATTERN="LXGWNeo*Screen*"
