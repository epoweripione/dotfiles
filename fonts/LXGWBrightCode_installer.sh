...
# [LXGW Bright Code](https://github.com/lxgw/LxgwBright-Code)
INSTALLER_APP_NAME="LXGW Bright Code"
INSTALLER_GITHUB_REPO="lxgw/LxgwBright-Code"
INSTALLER_INSTALL_NAME="LXGWBrightCode"

INSTALLER_MATCH_PATTERN="LXGWBrightCode*"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LxgwBrightCode.7z"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LxgwBrightCodeGB.7z"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LxgwBrightCodeTC.7z"
    )
