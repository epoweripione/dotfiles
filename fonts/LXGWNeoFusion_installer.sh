...
# [霞鹜新晰黑＆霞鹜新致宋 融合版](https://github.com/lxgw/LxgwNeoXiZhi-Fusion)
INSTALLER_APP_NAME="霞鹜新晰黑＆霞鹜新致宋 融合版"
INSTALLER_GITHUB_REPO="lxgw/LxgwNeoXiZhi-Fusion"
INSTALLER_INSTALL_NAME="LXGWNeoFusion"
...
if [[ "${INSTALLER_IS_INSTALL}" == "yes" ]]; then
    ...
    INSTALLER_DOWNLOAD_URLS=(
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWNeoXiHeiFusion.ttf"
        "https://github.com/${INSTALLER_GITHUB_REPO}/releases/download/v${INSTALLER_VER_REMOTE}/LXGWNeoZhiSongFusion.ttf"
    )
